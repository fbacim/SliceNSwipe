...
// Overall Leap.Controller object that will instantiate hands and tools when they appear.
public class HandController : MonoBehaviour {
  ...
  protected Leap.Controller leap_controller_;
  ...
  void OnDrawGizmos() {
    // Draws the little Leap Motion Leap.Controller in the Editor view.
  ...
  void Awake() {
    ...
    Leap.Controller.PolicyFlag policy_flags = leap_controller_.PolicyFlags;
    if (isHeadMounted)
      policy_flags |= Leap.Controller.PolicyFlag.POLICY_OPTIMIZE_HMD;
    else
      policy_flags &= ~Leap.Controller.PolicyFlag.POLICY_OPTIMIZE_HMD;
  ...
  public Leap.Controller GetLeapController() {
